...
import { ActivityIndicator, Animated, Dimensions, Easing, Text, View, FlatList } from 'react-native'
const { width } = Dimensions.get('window')
class FlatlistWithRefresh extends Component {
    constructor(props) {
        super(props)
